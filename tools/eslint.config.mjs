...
export default defineConfig([
  {
    ...
    rules: {
      // Allow single-line control statements without braces; require braces only for multi-line bodies
      curly: ['error', 'multi-line'],
      // Ensure single-line bodies are on the same line as their controlling statement
      ...
      indent: ['error', 2, { SwitchCase: 0, ignoredNodes: [
