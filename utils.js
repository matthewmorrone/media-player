...
// -----------------------------
// Centralized developer console logging (non-UI)
// -----------------------------
// devLog(level, scope, ...args) routes to the appropriate console method with a consistent prefix.
// Levels: 'debug' | 'info' | 'warn' | 'error' | 'log'
export function devLog(level, scope, ...args) {
  try {
